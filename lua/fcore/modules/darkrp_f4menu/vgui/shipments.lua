...
vgui.Register("fcore::f4::shipment::panel", PANEL, "FCore.Button")
    ...
    for _,category in ipairs(categories) do
        if #category.members > 0 then
            ...
            for _,ent in ipairs(category.members) do
                ...
                local e = vgui.Create("fcore::f4::shipment::panel")
...
FCore.F4Menu:AddPanel("Paczki", "fcore::f4::shipments", PANEL, "DPanel", 3, 0xf16b)